class AdministratorsController < ApplicationController
  ...
  before_action :super_admin, only: [:index] #, :make_admin]
  ...
  private
    ...
    def administrator_params
      params.require(:administrator).permit(:firstname, :lastname, :access_level, :contact, :school_id, :email, :password)
    end
    
    def super_admin
      if current_administrator.access_level == 2
